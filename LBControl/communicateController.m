...
- (void)viewDidLoad {
    ...
    [btn1 setImage:[UIImage imageNamed:@"im_post.png"] forState:UIControlStateNormal];
    ...
    [btn2 setImage:[UIImage imageNamed:@"im_activity.png"] forState:UIControlStateNormal];
    ...
    [btn3 setImage:[UIImage imageNamed:@"im_vote.png"] forState:UIControlStateNormal];
...
- (void)bt1clicked:(UIButton *)sender{
    expressController *vc1 = [[expressController alloc]init];
...
- (void)bt3clicked:(UIButton *)sender{
    expressController *vc1 = [[expressController alloc]init];
    [self presentViewController:vc1 animated:NO completion:nil];
}
