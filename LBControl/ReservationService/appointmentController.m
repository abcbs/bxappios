...
- (void)viewDidLoad {
    ...
    [btn1 setImage:[UIImage imageNamed:@"im_reservation_baojie.png"] forState:UIControlStateNormal];
    ...
    [btn2 setImage:[UIImage imageNamed:@"im_reservation_jia.png"] forState:UIControlStateNormal];
