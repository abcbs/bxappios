...
@interface BSAlbumsViewController () <PHPhotoLibraryChangeObserver>
...
@implementation BSAlbumsViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationItem.title = NSLocalizedStringFromTableInBundle(@"albums.title", @"BSImagePicker", self.imagePickerController.assetBundle, nil);
...
{
    BSAssetsViewController *assetsViewController = segue.destinationViewController;
...
{
    if ([self.imagePickerController.delegate respondsToSelector:@selector(imagePickerControllerDidCancel:)]) {
...
{
    BSAlbumCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AlbumCell" forIndexPath:indexPath];
