...
- (void)initTableData
{
    NSString *businessAreas = @"";
    if (self.addressComponent.businessAreas.count > 0)
    {
        AMapBusinessArea *ba = self.addressComponent.businessAreas[0];
        businessAreas = [ba description];
    }
    ...
    self.titleArray = @[@"省", @"市(citiCode)", @"地区(adCode)", @"乡镇", @"社区", @"建筑", @"门牌信息", @"商圈"];
}
