...
@interface BSRadarNearbyViewController ()<UITableViewDataSource, UITableViewDelegate, BMKMapViewDelegate, BMKRadarManagerDelegate> {
...
@implementation BSRadarNearbyViewController
