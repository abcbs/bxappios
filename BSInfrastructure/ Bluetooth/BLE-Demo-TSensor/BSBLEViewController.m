...
@interface BSBLEViewController ()  <LeDiscoveryDelegate, LeTemperatureAlarmProtocol, UITableViewDataSource, UITableViewDelegate>
...
@implementation BSBLEViewController
